...
import (
	...
	"github.com/AmbitionLover/goconvey/convey/reporting"
	"github.com/AmbitionLover/goconvey/web/server/contract"
)
...
const input_NoGoFiles = `can't load package: package github.com/AmbitionLover/goconvey: no buildable Go source files in /Users/matt/Work/Dev/goconvey/src/github.com/AmbitionLover/goconvey`

var expected_NoGoFiles = contract.PackageResult{
	PackageName: "github.com/AmbitionLover/goconvey",
...
PASS
ok  	github.com/AmbitionLover/goconvey/scripts	0.011s`

var expected_NoTestFunctions = contract.PackageResult{
	PackageName: "github.com/AmbitionLover/goconvey/scripts",
	Outcome:     contract.NoTestFunctions,
	BuildOutput: input_NoTestFunctions,
}

const input_BuildFailed_InvalidPackageDeclaration = `
can't load package: package github.com/AmbitionLover/goconvey/examples:
...
var expected_BuildFailed_InvalidPackageDeclaration = contract.PackageResult{
	PackageName: "github.com/AmbitionLover/goconvey/examples",
...
FAIL	github.com/AmbitionLover/goconvey/examples [setup failed]
`
...
# github.com/AmbitionLover/goconvey/examples
...
FAIL	github.com/AmbitionLover/goconvey/examples [build failed]
`
...
# github.com/AmbitionLover/goconvey/t
./t_test.go:23: import "github.com/AmbitionLover/goconvey/t" while compiling that package (import cycle)
FAIL	github.com/AmbitionLover/goconvey/t [build failed]
`

var expected_BuildFailed_ImportCycle = contract.PackageResult{
	PackageName: "github.com/AmbitionLover/goconvey/t",
	Outcome:     contract.BuildFailure,
...
--- PASS: TestOldSchool_PassesWithMessage (0.05 seconds)
	old_school_test.go:10: I am a passing test.
		With a newline.
PASS
coverage: 100.0%% of statements in github.com/AmbitionLover/goconvey/convey, github.com/AmbitionLover/goconvey/convey/gotest, github.com/AmbitionLover/goconvey/convey/reporting
ok  	github.com/AmbitionLover/goconvey/webserver/examples	0.018s
`

var expectedOldSchool_Passes = contract.PackageResult{
	PackageName: "github.com/AmbitionLover/goconvey/webserver/examples",
	Elapsed:     0.018,
	Coverage:    100,
...
FAIL
exit status 1
FAIL	github.com/AmbitionLover/goconvey/webserver/examples	0.017s
`
...
exit status 1
FAIL	github.com/AmbitionLover/goconvey/webserver/examples	0.414s
`
...
github.com/AmbitionLover/goconvey/webserver/examples.TestOldSchool_Panics(0x210292000)
