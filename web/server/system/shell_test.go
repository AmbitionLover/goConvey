...
import (
	...
	. "github.com/AmbitionLover/goconvey/convey"
)
...
func TestShellCommandComposition(t *testing.T) {
	var (
		...
		goConvey         = Command{Output: "[fmt github.com/AmbitionLover/goconvey/convey net/http net/http/httptest path runtime strconv strings testing time]"}
